            ...
            <div class="col-xl-8">
                <div class="card">
                    <div class="card-body">
                        <div class="float-end">
                            <div class="dropdown">
                                <a class="dropdown-toggle text-reset" href="index.html#" id="dropdownMenuButton5"
            ...
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="float-end">
                            <div class="dropdown">
                                <a class="dropdown-toggle text-reset" href="index.html#" id="dropdownMenuButton1"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="fw-semibold">Sort By:</span> <span class="text-muted">Yearly<i
                                            class="mdi mdi-chevron-down ms-1"></i></span>
                                </a>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body">
                        <div class="float-end">
                            <div class="dropdown">
                                <a class=" dropdown-toggle" href="index.html#" id="dropdownMenuButton2"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="text-muted">All Members<i class="mdi mdi-chevron-down ms-1"></i></span>
                                </a>

                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton2">
                                    <a class="dropdown-item" href="index.html#">Locations</a>
                                    <a class="dropdown-item" href="index.html#">Revenue</a>
                                    <a class="dropdown-item" href="index.html#">Join Date</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body">
                        <div class="float-end">
                            <div class="dropdown">
                                <a class="dropdown-toggle" href="index.html#" id="dropdownMenuButton3"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton3">
                                    <a class="dropdown-item" href="index.html#">Recent</a>
                                    <a class="dropdown-item" href="index.html#">By Users</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="float-end">
                            <div class="dropdown">
                                <a class="dropdown-toggle" href="index.html#" id="dropdownMenuButton4"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="text-center">
                            ...
                            <h5><a href="index.html#" class="text-dark">Facebook - <span class="text-muted font-16">125
                                        sales</span> </a></h5>
                            <p class="text-muted">Maecenas nec odio et ante tincidunt tempus. Donec vitae
                                sapien ut libero venenatis faucibus tincidunt.</p>
                            <a href="index.html#" class="text-reset font-16">Learn more <i
                        ...
                        <div class="mt-3 text-center">
                            <a href="index.html#" class="text-primary font-size-14 fw-medium">View All
                                Sources <i class="mdi mdi-chevron-right"></i></a>
                        </div>
